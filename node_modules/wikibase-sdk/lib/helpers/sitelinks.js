const { fixedEncodeURIComponent, replaceSpaceByUnderscores, isPlainObject } = require('wikibase-sdk/lib/utils/utils')
const wikidataBase = 'https://www.wikidata.org/wiki/'
const languages = require('wikibase-sdk/lib/helpers/sitelinks_languages')
