const { forceArray } = require('wikibase-sdk/lib/utils/utils')
const { isItemId } = require('wikibase-sdk/lib/helpers/helpers')
const validate = require('wikibase-sdk/lib/helpers/validate')
...
module.exports = sparqlEndpoint => {
  const sparqlQuery = require('wikibase-sdk/lib/queries/sparql_query')(sparqlEndpoint)
