...
CSL.Output.Queue.prototype.append = function (str, tokname, notSerious, ignorePredecessor, noStripPeriods, apskey) {
    var token, blob, curr;
    var useblob = true;
    if (notSerious) {
    ...
    blob = new CSL.Blob(str, token, undefined, apskey);
    curr = this.current.value();
        ...
        if ("string" === typeof blobjr.blobs) {
            if ("number" === typeof blobjr.num) {
                ...
                if (b && b.length) {
                    ...
                    if (blobjr["white"] !== undefined){
                        b = "<" + blobjr["white"] + ">" + b + "</" + blobjr["white"] + ">";
                    }
...
CSL.Output.Queue.prototype.renderBlobs = function (blobs, delim, in_cite, parent) {
    ...
    var apskey = '';
    if (parent){
        if (parent.blobs.length == 2 && parent.blobs[0].strings['term'] != undefined){
            apskey = parent.blobs[0].strings.term
        }
    }
    ...
    for (pos = 0; pos < len; pos += 1) {
        ...
        if ("string" === typeof blob) {
            ...
            // notSerious
            if (apskey == ''){
                this.append(str, "empty", true, undefined, undefined, "page");
            }
            else{
                this.append(str, "empty", true, undefined, undefined, "page");
            }
...
CSL.getAmbiguousCite = function (Item, disambig, visualForm, item) {
    ...
    CSL.getCite.call(this, Item, itemSupp, null, false);//white=1
    // !!!
...
CSL.getBibliographyEntries = function (bibsection) {
    ...
    for (i = 0, ilen = input.length; i < ilen; i += 1) {
        ...
        // var res1 = this.output.queue; //white

        //res = this.output.string(this, this.output.queue)
        //const util = require('util')

        //console.log(util.inspect(this.output.queue, {showHidden: false, depth: null, colors: true}))
        ...
        func = function (state, Item) {
            ...
            if ("undefined" !== typeof value) {
                ...
                if (state.tmp.date_collapse_at.length) {
                    ...
                    last_string_output = value;
                    // state.output.append(value, this, undefined, undefined, undefined, "date-parts");//white-date
                    state.output.append(value, this, undefined, undefined, undefined);//white-date
                }
...
CSL.NameOutput.prototype._familyName = function (name) {
    ...
    //    str = str + "==aps==" + "family";
    //}
    if (this.state.output.append(str, this.family_decor, true, undefined,undefined,"family")) {
        return this.state.output.pop();
    }
    return false;
};
...
CSL.NameOutput.prototype._givenName = function (name, pos, i) {
   ...
   if (gdropt && gdropt.slice(-14) === "-with-initials") {
    ...
    var rendered = this.state.output.append(str, this.given_decor, true, undefined, undefined, "given");//white
    if (rendered) {
                                ...
                                if (this.variables[0]) {
                                    ...
                                    if (value) {
                                        ...
                                        if (state.opt.development_extensions.wrap_url_and_doi) {
                                            ...
                                            if (this.variables[0] == "DOI"){//white-doi
                                                state.output.append(value, this, false, false, true, this.variables[0]);
                                            }
                                            else{
                                                state.output.append(value, this, false, false, true);
                                            }
    ...
    function getOutputFunction(variables, family_var, abbreviation_fallback, alternative_varname) {
        ...
        return function (state, Item, item) {
            ...
            if (secondary || tertiary) {
                ...
                CSL.UPDATE_GROUP_CONTEXT_CONDITION(state, null, null, primary_tok, primary_tok.strings.prefix + primary);
                if (primary_tok.variables[0] == "title"){
                    state.output.append(primary, primary_tok,undefined,undefined,undefined,"title");//white-title
                }
                else{
                    // state.output.append(primary, primary_tok, undefined, undefined, undefined, 'publisher-place');//white-title
                    state.output.append(primary, primary_tok, undefined, undefined, undefined);//white-title
                }
...
CSL.Blob = function (str, token, levelname, apskey) {
    var len, pos, key, tag;
